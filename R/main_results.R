...
##23
lm.23<-ivreg(probWinpost~(annualwinspre)+idperiodpost|((annualwinspre_close>0)+idperiodpost),data=merged.wins)
...
##11
lm.43<-ivreg(probWinpost~(winspre)+idperiodpost|((winspre_close>0)+idperiodpost),data=merged.wins)
